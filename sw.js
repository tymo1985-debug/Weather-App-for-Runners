...
const SHELL_CACHE = `${PREFIX}shell-v18`;
const API_CACHE = `${PREFIX}api-v6`;
const API_TTL_MS = 5 * 60 * 1000;
const API_MAX_ENTRIES = 20;
const SHELL = [
  './', './index.html', './css/styles.css',
  './js/app.js', './js/home-ui.js', './js/run-plan.js', './js/weather-watch.js', './js/route-plan.js', './js/run-history.js', './js/engine.js', './js/icons.js',
