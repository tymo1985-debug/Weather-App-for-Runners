...
export const RELEASE_NOTES = {
  en: [
    ...
    'Radar is a compact preview on the main Weather screen and expands into the full tool when needed.',
    'The preview uses quick times: Now, +30 min, +1 h, +3 h and +6 h instead of the long slider.',
  ...
  ru: [
    ...
    'На основном экране радар стал компактным превью, а полный инструмент открывается по развороту.',
    'Вместо длинного ползунка в превью используются быстрые точки: Сейчас, +30 мин, +1 ч, +3 ч и +6 ч.',
    'Play, полная шкала времени и управление картой теперь остаются только в полноэкранном радаре.'
  ]
};
